...
public class EditCandidate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String foreign_languages = request.getParameter("foreign_language");
        int candidateId = Integer.parseInt(request.getParameter("candidate_id"));

        candidateBean.updateCandidate(candidateId, name, surname, phone, email, birthday, sex, nationality, applied_job, career_level, study_level, native_language, foreign_languages);
