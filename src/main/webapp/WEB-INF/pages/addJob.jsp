<%-- 
    Document   : addJob
    Created on : Jan 17, 2021, 7:22:53 PM
    Author     : neagoe
--%>
    ...
    <form class="needs-validation" novalidate method="POST" action="${pageContext.request.contextPath}/AddJob">
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="job_name" name="job_name" placeholder="..." value="" required>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="type" name="type" placeholder="..." value="" required>
                <div class="invalid-feedback">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="password">Study level</label>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="email">Career level</label>
